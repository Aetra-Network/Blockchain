...
$moduleCatalog = @(
  ...
  [ordered]@{ Module = "x/reputation"; Label = '`x/reputation`'; Prefix = "REP"; Value = $true; EvidenceRoots = @("x\reputation", "docs\module-boundaries.md"); EvidenceTerms = @("reputation", "score", "rate limit", "priority") },
