...
var (
	...
	_	gogoproto.Message	= &MsgWithdrawExcessRent{}
	_	gogoproto.Message	= &MsgWithdrawExcessRentResponse{}
	_	gogoproto.Message	= &MsgFreezeExpiredContract{}
	_	gogoproto.Message	= &MsgFreezeExpiredContractResponse{}
	_	gogoproto.Message	= &MsgDeleteExpiredContract{}
	_	gogoproto.Message	= &MsgDeleteExpiredContractResponse{}
	_	gogoproto.Message	= &MsgUpdateStorageRentParams{}
	_	gogoproto.Message	= &MsgUpdateStorageRentParamsResponse{}
)

type MsgServer interface {
	PayStorageRent(context.Context, *MsgPayStorageRent) (*MsgPayStorageRentResponse, error)
	WithdrawExcessRent(context.Context, *MsgWithdrawExcessRent) (*MsgWithdrawExcessRentResponse, error)
	FreezeExpiredContract(context.Context, *MsgFreezeExpiredContract) (*MsgFreezeExpiredContractResponse, error)
	...
	UpdateStorageRentParams(context.Context, *MsgUpdateStorageRentParams) (*MsgUpdateStorageRentParamsResponse, error)
}
...
func (UnimplementedMsgServer) WithdrawExcessRent(ctx context.Context, req *MsgWithdrawExcessRent) (*MsgWithdrawExcessRentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WithdrawExcessRent not implemented")
}

func (UnimplementedMsgServer) FreezeExpiredContract(ctx context.Context, req *MsgFreezeExpiredContract) (*MsgFreezeExpiredContractResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FreezeExpiredContract not implemented")
}
...
func (UnimplementedMsgServer) DeleteExpiredContract(ctx context.Context, req *MsgDeleteExpiredContract) (*MsgDeleteExpiredContractResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteExpiredContract not implemented")
}

func (UnimplementedMsgServer) UpdateStorageRentParams(ctx context.Context, req *MsgUpdateStorageRentParams) (*MsgUpdateStorageRentParamsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateStorageRentParams not implemented")
}
...
var Msg_serviceDescVal = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName:	"WithdrawExcessRent",
			Handler:	_Msg_WithdrawExcessRent_Handler,
		},
		{
			MethodName:	"FreezeExpiredContract",
			Handler:	_Msg_FreezeExpiredContract_Handler,
		},
		{
		...
		{
			MethodName:	"DeleteExpiredContract",
			Handler:	_Msg_DeleteExpiredContract_Handler,
		},
		{
			MethodName:	"UpdateStorageRentParams",
			Handler:	_Msg_UpdateStorageRentParams_Handler,
		},
	},
...
func buildStorageRentTxFileDescriptor() []byte {
	fd := &descriptorpb.FileDescriptorProto{
		...
		MessageType: []*descriptorpb.DescriptorProto{
			...
			messageDescriptor("MsgWithdrawExcessRent"),
			messageDescriptor("MsgWithdrawExcessRentResponse"),
			messageDescriptor("MsgFreezeExpiredContract"),
			messageDescriptor("MsgFreezeExpiredContractResponse"),
			messageDescriptor("MsgUnfreezeContract"),
			messageDescriptor("MsgUnfreezeContractResponse"),
			messageDescriptor("MsgDeleteExpiredContract"),
			messageDescriptor("MsgDeleteExpiredContractResponse"),
			messageDescriptor("MsgUpdateStorageRentParams"),
			messageDescriptor("MsgUpdateStorageRentParamsResponse"),
		},
		Service: []*descriptorpb.ServiceDescriptorProto{
			{
				...
				Method: []*descriptorpb.MethodDescriptorProto{
					...
					serviceMethodDescriptor("WithdrawExcessRent", "MsgWithdrawExcessRent", "MsgWithdrawExcessRentResponse"),
					serviceMethodDescriptor("FreezeExpiredContract", "MsgFreezeExpiredContract", "MsgFreezeExpiredContractResponse"),
					...
					serviceMethodDescriptor("UpdateStorageRentParams", "MsgUpdateStorageRentParams", "MsgUpdateStorageRentParamsResponse"),
				},
			},
		},
	}
